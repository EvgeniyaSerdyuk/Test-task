...
|**Альтернативные сценарии**|А1. Если цена товара меньше 0, система высвечивает сообщение о некорректности введенных данных <br> А2. Система возвращает объявление на доработку, если контент (фотографии/текст) не соответствуют требованиям законодательства и ли оферты площадки |
|||
