...
- Исключение 1-ой линии технической поддержки с целью сокращения затрат на содержание отдела, минимизации риска потери данных и исключения ручного ввода.
# Задача 2
...
- Я как продавец хочу получать рекомендации по рыночной цене, чтобы повысить конкурентоспособность и эффективность продаж.
...
|:---|:---|
|**Актор**|Продавец|
|**Предусловия**|Продавец зарегистрирован, вся юридическая и платежная информация заполнена|
...
# Задача 3.2
![Диаграмма деятельности для процесса регистрации пользователя](task3.2.png)
